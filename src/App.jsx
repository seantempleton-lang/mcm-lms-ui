    ...
    <Layout me={me}>
      <Routes>
        ...
        <Route
          ...
          element={<RequireRole me={me} roles={['SUPERVISOR', 'ADMIN']}><SessionsList /></RequireRole>}
        />
        <Route
          path="/supervisor/sessions/:id"
          element={<RequireRole me={me} roles={['SUPERVISOR', 'ADMIN']}><SessionRun /></RequireRole>}
        />
        <Route
          path="/supervisor/competencies"
          element={<RequireRole me={me} roles={['SUPERVISOR', 'ADMIN']}><CompetenciesView /></RequireRole>}
        />
